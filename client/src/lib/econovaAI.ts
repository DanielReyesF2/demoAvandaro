...
const PRECIO_RECICLABLES = 1200; // $/tonelada
const PRECIO_COMPOSTA = 400; // $/tonelada
const PRECIO_REUSO = 800; // $/tonelada
const COSTO_GESTION_TOTAL = 900; // $/tonelada
...
const DEMO_RESPONSES: Record<string, string> = {
  ...
  // Pregunta 2: Financiera - Impactante con números concretos (actualizada con nuevos valores)
  'perdida': '💰 **Actualmente los costos superan los ingresos**\n\nEl manejo de residuos te cuesta **más** de lo que generas por reciclables. Esto se debe a que los costos de gestión operativa ($900/ton) y relleno sanitario ($850/ton) son altos, mientras que los precios de venta de reciclables son bajos ($1,200/ton para reciclables, $400/ton para composta).\n\n💡 **La solución**: Enfócate en reducir la cantidad enviada a relleno sanitario aumentando la tasa de desviación. Cada tonelada menos en relleno significa **$850 menos en costos** y más material para reciclar o compostar que genere ingresos. Mejora la separación en origen para maximizar el valor de los reciclables.',
